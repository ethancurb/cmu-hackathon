...
This report supports decisions; it is not required reading before every task. Every agent reads the distilled [STRATEGY](STRATEGY.md), then works from [PROJECT](PROJECT.md) and [ARCHITECTURE](ARCHITECTURE.md). Consult the sections below when selecting an idea, changing tracks, challenging an assumption, or preparing the demonstration.
...
| --- | --- | --- |
| ACM@CMU | [HackCMU 2026 Opening Ceremony](../HackCMU%202026%20Opening%20Ceremony.pdf), supplied 2026 deck, especially pp. 6, 8–9, 16–21, 23, 33–46, 51 | Current event instructions, themes, rubric, format, prizes. |
