...
2026-09-12T19:21:28Z → [#24](https://github.com/ethancurb/cmu-hackathon/issues/24) → removed the redundant List mode and its panel, reduced the visual switcher to Map/Vehicle, and restored the three live arrival tiles immediately below either view.
